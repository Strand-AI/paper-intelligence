...
- Search no longer blocks on an unconditional whole-library R2 pull.

### Fixed
- Direct PDF searches inspect only the requested PDF and its output directory, never unrelated sibling temp content.
